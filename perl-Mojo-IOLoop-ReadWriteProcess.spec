...
Source0  : https://cpan.metacpan.org/authors/id/S/SZ/SZARATE/Mojo-IOLoop-ReadWriteProcess-0.27.tar.gz
...
%prep
%setup -q -n Mojo-IOLoop-ReadWriteProcess-0.27
cd %{_builddir}/Mojo-IOLoop-ReadWriteProcess-0.27
...
cp %{_builddir}/Mojo-IOLoop-ReadWriteProcess-0.27/LICENSE %{buildroot}/usr/share/package-licenses/perl-Mojo-IOLoop-ReadWriteProcess/73e24a2cd5ad78be7ec077f7a151a688f7eb298d
if test -f Makefile.PL; then
